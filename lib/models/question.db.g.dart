...
const QuestionSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'questionTypeIndex': PropertySchema(
      id: 2,
      name: r'questionTypeIndex',
      type: IsarType.long,
    ),
...
void _questionSerialize(
  ...
  writer.writeLong(offsets[2], object.questionTypeIndex);
...
Question _questionDeserialize(
  ...
  final object = Question(
    ...
    questionTypeIndex: reader.readLongOrNull(offsets[2]) ?? 0,
...
extension QuestionQueryWhere on QueryBuilder<Question, Question, QWhereClause> {
  ...
  QueryBuilder<Question, Question, QAfterWhereClause> isarIdLessThan(
    Id isarId, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
...
extension QuestionQueryFilter
  ...
  QueryBuilder<Question, Question, QAfterFilterCondition> idStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Question, Question, QAfterFilterCondition> idEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Question, Question, QAfterFilterCondition> idContains(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Question, Question, QAfterFilterCondition> idMatches(
    String pattern, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Question, Question, QAfterFilterCondition> idIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  QueryBuilder<Question, Question, QAfterFilterCondition> idIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  QueryBuilder<Question, Question, QAfterFilterCondition>
  questionTypeIndexEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(property: r'questionTypeIndex', value: value),
      );
    });
  }

  QueryBuilder<Question, Question, QAfterFilterCondition>
  questionTypeIndexGreaterThan(int value, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.greaterThan(
          include: include,
          property: r'questionTypeIndex',
          value: value,
        ),
      );
    });
  ...
  QueryBuilder<Question, Question, QAfterFilterCondition>
  questionTypeIndexLessThan(int value, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.lessThan(
          include: include,
...
extension QuestionQuerySortBy on QueryBuilder<Question, Question, QSortBy> {
  ...
  QueryBuilder<Question, Question, QAfterSortBy> sortByQuestionTypeIndex() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'questionTypeIndex', Sort.asc);
    });
  }

  QueryBuilder<Question, Question, QAfterSortBy> sortByQuestionTypeIndexDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'questionTypeIndex', Sort.desc);
    });
  }
...
extension QuestionQuerySortThenBy
  ...
  QueryBuilder<Question, Question, QAfterSortBy> thenByQuestionTypeIndex() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'questionTypeIndex', Sort.asc);
    });
  }

  QueryBuilder<Question, Question, QAfterSortBy> thenByQuestionTypeIndexDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'questionTypeIndex', Sort.desc);
    });
  }
...
extension QuestionQueryWhereDistinct
  ...
  QueryBuilder<Question, Question, QDistinct> distinctById({
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Question, Question, QDistinct> distinctByQuestionTypeIndex() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'questionTypeIndex');
    });
  }
...
extension QuestionQueryProperty
  ...
  QueryBuilder<Question, String, QQueryOperations> idProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'id');
    });
  }

  QueryBuilder<Question, int, QQueryOperations> questionTypeIndexProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'questionTypeIndex');
    });
  }
